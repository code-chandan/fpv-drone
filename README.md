...
This thing isn’t printed yet, btw. The model is locked and loaded in Fusion 360. 
...
| Image | Description |
|-------|-------------|
| <img width="1126" height="1077" alt="Screenshot 2025-07-28 163300" src="https://github.com/user-attachments/assets/799fd643-32b4-4d3c-bec1-a35a97d1698b" /> | Full Fusion 360 render of the frame. All parts modeled to scale with 5" props |
...
| Image | Description |
|-------|-------------|
| <img width="1106" height="578" alt="image" src="https://github.com/user-attachments/assets/9c17238e-b17f-4c70-b001-d8087d68bc32" /> | diy transmitter |

| Image | Description |
|-------|-------------|
| <img width="1350" height="598" alt="Screenshot 2025-07-28 191118" src="https://github.com/user-attachments/assets/5b05099d-bfce-4793-b096-0f17cce53640" /> | controller case |


| Image | Description |
|-------|-------------|
| <img width="615" height="465" alt="image" src="https://github.com/user-attachments/assets/0572cb90-249a-4500-9ea1-2744c1bbab2a" /> | diy receiver  |

| Image | Description |
|-------|-------------|
| <img width="865" height="878" alt="image" src="https://github.com/user-attachments/assets/4bc5b02d-a11b-48f7-8118-3d761dfdad9e" /> | flight controller ( more layers cus so much routing) |
